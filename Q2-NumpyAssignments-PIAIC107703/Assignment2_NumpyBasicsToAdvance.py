...
# %load "C:\Users\ahmed.TOYOTA-CENTRAL\Desktop\New folder\AI-Q2-learning-resources-master\NumpyAssignments\Assignment2_NumpyBasicsToAdvance.py"
...
def function8():
    ...
    x = np.full(10,6,dtype=np.uint32).reshape(2,5)
...
def function17():
  ...
  return np.where((arr%5==0) & (arr%3==0), 'YES',np.where((arr%5!=0) | (arr%5==0),'NO',arr))
